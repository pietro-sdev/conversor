      ...
      <section className="flex items-center justify-center bg-background h-full max-w-3xl w-full p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Utilize seu e-mail e senha ou facebook e google para entrar.
            </CardDescription>
          </CardHeader>
          <CardContent>
          <Button
            ...
            <Button className="w-full mt-6 font-semibold bg-[#2C3E50]">Entrar</Button>
            <Label className="flex justify-center text-xs font-semibold tracking-tighter text-muted-foreground mt-4">
            Ainda não tem conta? <a href="/register" className="text-black ml-1 underline">Registre-se</a>
            </Label>          
            </CardContent>
          <CardFooter>
